<!DOCTYPE html>
<%@page import="com.virgo.util.FaultCategory"%>
...
<body>
	...
	<div class="col-lg-4" id="result_lable"
		style="display:; position: fixed; margin: auto; left: 0; right: 0; top: 30%; bottom: 0;">
		<div class="panel panel-green">
			<div class="panel-heading">故障预测结果</div>
			<div class="panel-body">
				<p>
					故障类别： <span id="lable" style=""><%=FaultCategory.faultCategoryMap.get(request
					.getAttribute("lable"))%></span>
				</p>
				<hr />
				<p>建议处理方案：</p>
			</div>
			<div class="panel-footer" align="center">
				<button type="button" onclick="display()" class="btn btn-danger">确认</button>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		function display() {
			document.getElementById("result_lable").style.display = "none";
		}
		function showWait() {
